...
#endif
{
	if (file)
		...
		return inactive_kddm_is_low(zone, sc);
#endif
	else
	...
	struct zone *zone, struct scan_control *sc, int priority)
{
	...
	if (is_active_lru(lru)) {
#ifdef CONFIG_KRG_MM
		if (inactive_list_is_low(zone, sc, file, kddm))
		    shrink_active_list(nr_to_scan, zone, sc, priority, file, kddm);
#else
...
#ifdef CONFIG_KRG_MM
	return shrink_inactive_list(nr_to_scan, zone, sc, priority, file, kddm);
#else
