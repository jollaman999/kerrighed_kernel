...
#define X86_BUG_SWAPGS			X86_BUG(7) /* CPU is affected by speculation through SWAPGS */
#define X86_BUG_TAA			X86_BUG(8) /* CPU is affected by TSX Async Abort(TAA) */
#define X86_BUG_ITLB_MULTIHIT		X86_BUG(9) /* CPU may incur MCE during certain page attribute changes */
