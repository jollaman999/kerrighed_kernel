...
#ifdef CONFIG_KRG_FAF
			 struct used_address *used_address, struct file *faf_file)
#else
...
#ifdef CONFIG_KRG_FAF
	err = __sys_sendmsg(sock, msg, &msg_sys, flags, NULL, faf_file);
#else
...
#ifdef CONFIG_KRG_FAF
	err = __sys_recvmsg(sock, msg, &msg_sys, flags, 0, faf_file);
#else
