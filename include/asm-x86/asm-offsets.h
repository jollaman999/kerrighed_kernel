...
#define tsk_state 40 /* offsetof(struct task_struct, state)	# */
#define tsk_flags 60 /* offsetof(struct task_struct, flags)	# */
#define tsk_pid 1232 /* offsetof(struct task_struct, pid)	# */
...
#define TSS_stack_size 2048 /* sizeof(((struct tss_struct *)0)stack)	# */
